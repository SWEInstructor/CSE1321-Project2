...
public class Library {
	public void libraryEntrance(String NAME, String PLACE, String command, String[] inputs) {
	...
	public void libraryFront (String NAME) {
	...
	public void libraryBack(String NAME) {
        	String command = " ";
		String usecommand = " ";
		String place = " ";
