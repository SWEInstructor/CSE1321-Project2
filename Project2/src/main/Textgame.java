...
public class Textgame {
	public static String[] inputs = {"use","look","visit","check inventory","help"};
	...
	static String[] visitInput = { "libraryEntrance" , "libraryFrontSection","libraryBackSection", "home", "friendsHouse", "townSquare"};
...
//PLACE =  visitInput;
		...
		if(PLACE .equals ("townSquare")) {//fix this after checking other files****
			place = "townSquare";
			TownSquare ts = new TownSquare();
			ts.townSquare(NAME, place, command, inputs);
		}
		...
		house.Home1(NAME,  place,  command, inputs);
		place = "home";
		//Home.Home1(NAME,  place,  command, inputs);
		//return "home";
